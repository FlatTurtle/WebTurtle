...
<head>
    ...
    <meta charset="utf-8">
    <title></title>
    <link href="dist/css/style.css?v=1104" rel="stylesheet" type="text/css" />
    <link href="//fast.fonts.com/cssapi/66253153-9c89-413c-814d-60d3ba0d6ac2.css" type="text/css" >
    <link href="img/favicon.ico" rel="icon" type="image/x-icon">
</head>
<body>

    <div id="logo"><a href="https://flatturtle.com" target="_blank"><img src="img/logo.svg?v=1104"></a></div>
    <div id="legend">
    ...
    <![endif]-->
    <script src="dist/js/flatturtle.js?v=1104"></script>
